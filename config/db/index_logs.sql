...
CREATE INDEX IF NOT EXISTS idx_processing_type ON index_logs (processing_type);
...
COMMENT ON COLUMN index_logs.processing_type IS 'Document processing type (standard, hierarchical)';
